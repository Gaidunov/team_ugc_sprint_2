...
def measure_select():
    print('postgres:',timeit.timeit('pg_client.pg_select_review(1)', number=100, globals=globals()))
    print('mongo:',timeit.timeit('mongo_client.mongo_select(1)', number=100, globals=globals()))
...
def measure_likes():  
    ...
    print('mongo likes:', timeit.timeit('measure_likes_count_mongo()', number=1, globals=locals()))
    print('posrgres likes:', timeit.timeit('measure_likes_pg()', number=1, globals=locals()))
